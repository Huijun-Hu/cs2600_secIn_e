...
PtrToEmployee searchEmployeeByName(PtrToConstEmployee ptr, int tableSize, long targetName){
    return searchEmployeeTable(ptr, tableSize, &targetName, compareEmployeeName);

}

PtrToEmployee searchEmployeeByPhone(PtrToConstEmployee ptr, int tableSize, long targetPhone){
    return searchEmployeeTable(ptr, tableSize, &targetPhone, compareEmployeePhone);
}
